    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('customer', 'customer'), ('loan_representative', 'loan_representative'), ('loan_sanctioning_officer', 'loan_sanctioning_officer'), ('admin', 'admin'), ('account_head', 'count_head')], max_length=24, null=True)),
